...
public class TestLibrarian {
	...
	public void testMarkNERtag() {
		...
		try {
			...
			// (lib.markNERtag(text2)).toString() );
			// assertEquals("<NER>Queen Elizabeth II authored this book.</NER>",
			// (lib.markNERtag(text3)).toString());
			// assertEquals("<NER>written by Martin Luther King Jr.</NER>",
